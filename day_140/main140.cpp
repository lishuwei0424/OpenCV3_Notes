/*
案例 – 识别0～9印刷体数字 – PartTwo

实现识别的完整流程

根据第一部分的训练提取特征数据，作为参考，对输入的图像处理如下：
1.	二值化
2.	提取字符ROI区域
3.	对ROI提取特征向量
4.	对比特征向量，计算L2距离
...
PS：python的代码大家可以尝试自己实现 一下，或者谁实现了可以上传一下！

感谢大家的理解、信任与支持，我整理剩下部分的思路，把答应大家的tensorflow的分享内容做好，回报大家信任！我对OpenCV研习社的定位就是学会写代码！写出有价值的代码，在实践中学习！
*/
